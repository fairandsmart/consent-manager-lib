...
var DataFormWrapper = /** @class */ (function () {
  ...
  DataFormWrapper.prototype.render = function () {
    if (!this.rendered) {
      this.transformElement();
    }
    return this;
  };
  DataFormWrapper.prototype.onSend = function () {
    return this.onSend$;
  };
  ...
  DataFormWrapper.prototype.getSubject = function (entryId, entryField) {
    var _a;
    var entry =
      (_a = this.schema) === null || _a === void 0
        ? void 0
      ...
      if (result === null || result === void 0 ? void 0 : result.length) {
        ...
        if (!!entryField) {
          if (
            ...
            !!entryField &&
            Object.prototype.hasOwnProperty.call(dataEntry, entryField)
          ) {
        ...
        throw new Error(
          "Could not find subject for entry id " + entryId + " in form data"
        );
      }
    }
  };
  DataFormWrapper.prototype.populateDataStore = function (field) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        ...
        toAdd =
          ((_b = {}),
          (_b[types_1.FairQueryHelper.getPropertyFromExp(entry.query)] =
            field.value),
          _b);
        if (this.dataStore.dirty) {
          if (types_1.FairQueryHelper.getParentQuery(entry.query)) {
            matches = types_1.FairQueryHelper.apply(
              this.dataStore.store,
  ...
  DataFormWrapper.prototype.pushData = function () {

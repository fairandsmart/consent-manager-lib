...
exports.ThemeAutocomplete = void 0;
var ThemeAutocomplete = /** @class */ (function () {
    function ThemeAutocomplete() {
    }
    ThemeAutocomplete.createSnippets = function (language) {
        return ThemeAutocomplete.CSS_HINTS.map(function (entry) {
            return {
                text: entry.css,
    ...
    return ThemeAutocomplete;
}());
exports.ThemeAutocomplete = ThemeAutocomplete;
